                ...
                <div class="main-search-input-item">
                    <select data-placeholder="All Categories" class="chosen-select" id="restaurant_type">
                        ...
                        <?php $__currentLoopData = $restaurantTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restaurantType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($restaurantType->id); ?>"><?php echo e($restaurantType->name); ?></option>
            ...
            <div id="restaurants">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="<?php echo e(route('restaurant.show', $restaurant->code)); ?>" class="listing-item-container compact">
                            <div class="listing-item">
                                ...
                                <div class="listing-item-content">
                                    ...
                                    <h3><?php echo e($restaurant->name); ?> <i class="verified-icon"></i></h3>
    ...
    <script type="text/javascript">
        ...
        function filterRestaurants(){
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('listings.filter')); ?>",
                data: {
