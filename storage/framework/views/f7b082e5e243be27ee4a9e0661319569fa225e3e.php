<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12">
                <div class="col-lg-12">
                    <form method="POST" action="<?php echo e(route('fooditem.update')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="add-listing">
                            <div class="add-listing-section">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="chosen-select-no-single" name="food_category_id" required="true">
                                            <?php $__currentLoopData = $foodCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foodCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($foodCategory->id); ?>" 
                                ...
                                <div class="row with-forms">
                                    <div class="col-md-12">
                                        <h5>Name</h5>
                                        <input type="text" name="name" required="true" value="<?php echo e($foodItem->name); ?>">
                                    </div>
                                </div>
                                <div class="row with-forms">
                                    <div class="col-md-12">
                                        <h5>Descriptiom<span>(maximum 2000 characters)</span></h5>
                                        <textarea class="WYSIWYG" name="description" rows="2" id="description" spellcheck="true"><?php echo e($foodItem->description); ?></textarea>
                                    </div>
                                </div>
                                <div class="row with-forms">
                                    <div class="col-md-12">
                                        <h5>Price</h5>
                                        <input type="number" min="0" name="price" required="true" value="<?php echo e($foodItem->price); ?>">
                                    </div>
                                </div>
