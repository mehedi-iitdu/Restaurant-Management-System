					...
					<div class="comments listing-reviews">
						<ul>
							<li>
								...
								<div class="comment-content"><div class="arrow-comment"></div>
									<div class="comment-by">Your review <div class="comment-by-listing own-comment">on <a href="#">{{ $my_review->restaurant->name }}</a></div> <span class="date">{{ $my_review->date }}</span>
