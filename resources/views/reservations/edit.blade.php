            ...
            <div class="booking-pickers">
                ...
                <div class="form-group side-booking-person">
                    <select class="form-control select2" placeholder="Select Person" name="number_of_people">
                        ...
                        <option value="1" <?php if($reservation->number_of_people == 1) echo "selected"; ?> >1</option>
                        <option value="2" <?php if($reservation->number_of_people == 2) echo "selected"; ?> >2</option>
                        <option value="3" <?php if($reservation->number_of_people == 3) echo "selected"; ?> >3</option>
                        <option value="4" <?php if($reservation->number_of_people == 4) echo "selected"; ?> >4</option>
                        <option value="5" <?php if($reservation->number_of_people == 5) echo "selected"; ?> >5</option>
                        <option value="6" <?php if($reservation->number_of_people == 6) echo "selected"; ?> >6</option>
                        <option value="7" <?php if($reservation->number_of_people == 7) echo "selected"; ?> >7</option>
                        <option value="8" <?php if($reservation->number_of_people == 8) echo "selected"; ?> >8</option>
                        <option value="9" <?php if($reservation->number_of_people == 9) echo "selected"; ?> >9</option>
                        <option value="10" <?php if($reservation->number_of_people == 10) echo "selected"; ?> >10</option>
                        <option value="11" <?php if($reservation->number_of_people == 11) echo "selected"; ?> >11</option>
                        <option value="12" <?php if($reservation->number_of_people == 12) echo "selected"; ?> >12</option>
                        <option value="13" <?php if($reservation->number_of_people == 13) echo "selected"; ?> >13</option>
                        <option value="14" <?php if($reservation->number_of_people == 14) echo "selected"; ?> >14</option>
                        <option value="15" <?php if($reservation->number_of_people == 15) echo "selected"; ?> >15</option>
                        <option value="16" <?php if($reservation->number_of_people == 16) echo "selected"; ?> >16</option>
                        <option value="17" <?php if($reservation->number_of_people == 17) echo "selected"; ?> >17</option>
                        <option value="18" <?php if($reservation->number_of_people == 18) echo "selected"; ?> >18</option>
                        <option value="19" <?php if($reservation->number_of_people == 19) echo "selected"; ?> >19</option>
                        <option value="20" <?php if($reservation->number_of_people == 20) echo "selected"; ?> >20</option>
                        <option value="21" <?php if($reservation->number_of_people == 21) echo "selected"; ?> >21</option>
                        <option value="22" <?php if($reservation->number_of_people == 22) echo "selected"; ?> >22</option>
                        <option value="23" <?php if($reservation->number_of_people == 23) echo "selected"; ?> >23</option>
                    </select>
                </div>
                ...
                <div class="form-group side-booking-table">
                    <select class="form-control select2-table" placeholder="Select table" name="table_id">
                        @foreach(\App\RestaurantTable::where('restaurant_id', $reservation->restaurant->id)->get() as $table)
                ...
                <div class="form-group side-booking-color">
                    <label>
                        <input type="radio" name="color" value="35c496" <?php if($reservation->color == "35c496") echo "checked";?> >
                        <span class="checkmark color1"></span>
                    </label>
                    <label>
                        <input type="radio" name="color" value="00bbda" <?php if($reservation->color == "00bbda") echo "checked";?> >
                        <span class="checkmark color2"></span>
                    </label>
                    <label>
                        <input type="radio" name="color" value="aa85ef" <?php if($reservation->color == "aa85ef") echo "checked";?> >
                        <span class="checkmark color3"></span>
                    </label>
                    <label>
                        <input type="radio" name="color" value="be6b7f" <?php if($reservation->color == "be6b7f") echo "checked";?> >
                        <span class="checkmark color4"></span>
                    </label>
                    <label>
                        <input type="radio" name="color" value="ff3601" <?php if($reservation->color == "ff3601") echo "checked";?> >
                        <span class="checkmark color5"></span>
                    </label>
                    <label>
                        <input type="radio" name="color" value="ffd300" <?php if($reservation->color == "ffd300") echo "checked";?> >
...
<div class="side-booking-foot clearfix">
    ...
    <div class="side-foot-right pull-right">
        ...
        <div class="side-booking-delete">
            <button type="button" id="delete_reservation"><img src="{{asset('img/delete.svg')}}" alt=""></button>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $('#update_reservation').on('click', function(e){
        ...
        var table_id = $("select[name=table_id]").val();
